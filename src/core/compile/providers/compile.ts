...
import {
    Injectable, Injector, Component, NgModule, Compiler, ComponentFactory, ComponentRef, NgModuleRef, NO_ERRORS_SCHEMA, Inject
} from '@angular/core';
import { JitCompilerFactory } from '@angular/platform-browser-dynamic';
import { Platform, ActionSheetController, AlertController, LoadingController, ModalController, PopoverController, ToastController, IonicModule, IonicPageModule} from 'ionic-angular';
import { TranslateService, TranslateModule, TranslateLoader } from '@ngx-translate/core';
import { CoreLoggerProvider } from '@providers/logger';

// Import core providers.
import { CORE_PROVIDERS, createTranslateLoader } from '@app/app.module';
...
export class CoreCompileProvider {
    ...
    protected OTHER_PROVIDERS = [
       HttpClient, Platform, DomSanitizer, ActionSheetController, AlertController, LoadingController,
