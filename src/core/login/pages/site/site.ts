...
export class CoreLoginSitePage {
    ...
    url_select: string = 'Lms.ozyegin.edu.tr';

    constructor(navParams: NavParams, private ib: InAppBrowser ,
    ...
    GoToULE(){
        ...
        console.log("eula");
        this.navCtrl.push('CoreLoginEulPage');
    }
    /**
    ...
    showHelp(): void {
        ...
        // modal.present();
       const help = this.ib.create('https://solutioncenter.ozyegin.edu.tr');
       help.show();
    }
